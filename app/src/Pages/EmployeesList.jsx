 ...
 <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div className="flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
        <div>
           ...
           <label htmlFor="sort"  className="inline-flex items-center text-gray-500 ">Sort by:</label>
        ...
        <div className="relative">
            ...
            <input type="text" id="table-search-users" className="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for users" value={searchQuery}
      ...
      <tbody>
        {sortedEmployees .map((employee) => (
          <tr key={employee._id}  className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td>
                    <img className="w-10 h-10 rounded-full" src={'./src/assets/Mon Photo.jpeg'} alt="Jese image"/>
                    </td>
            ...
            <td className="px-6 py-4"> <Link to="/addEmployee" className="add">
                  <img src={'./src/assets/add.png'} width="20" height="20"/>
                </Link>
                <Link to={`/editEmployee/${employee._id}`}> <img src={'./src/assets/update.png'} width="20" height="20"/></Link>
